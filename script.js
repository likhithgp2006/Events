...
document.addEventListener("DOMContentLoaded", () => {
    ...
    // Scroll effect for navbar & active link update
    ...
    if (solarFlare && shockwaveRing && sudarshana && registrationCard) {
        ...
        setTimeout(() => {
            if (lightBeam) lightBeam.classList.add("active");
    ...
    // ========================================
    if (registrationForm && sudarshana) {
    ...
    if (registrationForm) {
        registrationForm.addEventListener("submit", function (event) {
            ...
            if (sudarshana) sudarshana.classList.add("hyperspin");

            if (solarFlare && shockwaveRing) {
            ...
            setTimeout(() => {
                ...
                if (sudarshana) sudarshana.classList.remove("hyperspin");
            }, 800);
